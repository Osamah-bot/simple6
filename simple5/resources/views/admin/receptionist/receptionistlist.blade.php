...
<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								<a href="#" class="btn add-btn" data-toggle="modal" data-target="#add_client"><i class="fa fa-plus"></i> New Doctor </a>
...
<!-- <a class="btn btn-success mb-2" id="new-user" data-toggle="modal">New Patient</a> -->
</div>
</div>
</div>
...
<tr><td></td><td style="text-align: right "><a href="#" class="btn btn-danger">OK</a> </td></tr>
</table>
</div>
</div>
</div>
