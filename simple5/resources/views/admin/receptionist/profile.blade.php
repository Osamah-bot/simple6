                    ...
                    <div class="profile-view">
                        <div class="profile-img-wrap">
                            <div class="profile-img">
                                <a href="">
                                    <img src={{ asset({{ 'storage/patient_images/'.$result->img_url}}) }} alt="">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="offerForm" action="{{ route('admin.editdoctorprofile') }}">
                        @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="col-form-label">Doctor BIRTHDATE <span class="text-danger">*</span></label>
                                <div class="cal-icon">
    ...
    <div id="change-password" class="" role="" style="display: none;">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <form method="POST" id="offerForm" action="{{ route('admin.chang-doctor-pass') }}">
                    @csrf
