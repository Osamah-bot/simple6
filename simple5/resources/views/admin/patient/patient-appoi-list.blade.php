						...
						<div class="row user-tabs">
							<div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
								<ul class="nav nav-tabs nav-tabs-bottom">
                                    <li class="nav-item col-sm-3"><a class="nav-link active" data-toggle="tab" href="#tasks">Appoinements</a></li>
									<li class="nav-item col-sm-3"><a class="nav-link" data-toggle="tab" href="#myprojects">Treatements</a></li>
				         		...
				         		<div id="tasks" class="tab-pane fade show active">
									<div class="project-task">
										<ul class="nav nav-tabs nav-tabs-top nav-justified mb-0">
											<li class="nav-item"><a class="nav-link active" href="#all_tasks" data-toggle="tab" aria-expanded="true">All Appoinements</a></li>
											<li class="nav-item"><a class="nav-link" href="#pending_tasks" data-toggle="tab" aria-expanded="false">Pending Appoinements</a></li>
											<li class="nav-item"><a class="nav-link" href="#completed_tasks" data-toggle="tab" aria-expanded="false">Completed Appoinements</a></li>
										</ul>
                                      ...
                                      <div class="row">
											...
											@foreach($pat_appoi as $p_appoi)
												...
												<div class="table-responsive " >
                                                    <b><p>Appoi-{{$appo_id=$p_appoi->appo_id}}</p></b>
														<table class="table table-striped custom-table datatable">
														<thead>
                                                            <tr style="background:#357ecd">
																	<th>Name</th>
																	<th>Patient ID</th>
																	<th>Reason</th>
																	<th>Date</th>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="#" class="avatar"><img src="{{asset('storage/patient_images/'.$result->img_url)}}" alt=""></a>
																			<a href="#">{{$result->fname}}  {{$result->lname}}</a>																		</h2>
																	</td>
																	<td>PAT-00{{$result->patient_id}}</td>
																	<td>{{$p_appoi->reason}}</td>
																	<td>{{$p_appoi->created_at}}</td>
                                                                    <td>{{$pat_reviw_doctor[$appo_id]}}
                                                                    <br>DOC-00{{$p_appoi->doctor_id}}</td>
																	<td>
																		<div class="dropdown action-label">
																			...
																			<a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o "></i>Pending</a>
																			<a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-success"></i> Accepted</a>
																			<a class="dropdown-item" href="#"><i class="fa fa-dot-circle-o text-danger"></i> Rejected</a>
																			<a class="dropdown-item" href="#"><i class="fa fa-circle text"></i> Completed</a>
																			</div>
																		</div>
																	</td>
																	<td class="text-right">
														...
														<div class="col-md-12">
															...
															<div class="table-responsive">
														        ...
														        <tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="#" class="avatar"><img src="{{asset($result->img_url)}}" alt=""></a>
