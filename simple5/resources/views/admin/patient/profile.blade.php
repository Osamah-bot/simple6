                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="profile-info-left">
                                    ...
                                    <a href="#" class="li" onclick="showChangPassDiv()">Change Password</a>
					...
					<div class="modal-dialog modal-dialog-centered modal-lg" role="document" >
						<div class="modal-content" >
							...
							<div class="modal-body" >
							  <form method="POST"  id="offerForm" enctype="multipart/form-data" action="{{route('admin.updatepatient','$result->patient_id')}}" >
                                  @csrf
									<div class="row">
									<div class="col-md-6">
											<div class="form-group">
												<label class="col-form-label">First Name <span class="text-danger">*</span></label>
												<input  id="fname" class="form-control" type="text" name='fname' value="{{ $result->fname }}" >
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="lname" class="form-control" type="text" name='lname' value="{{ $result->lname }}">
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="email" class="form-control floating" placeholder="example@gmail.com" type="email" name='email'
                                                 value="{{ $result->email }}" required readonly>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="col-form-label">Patient BIRTHDATE <span class="text-danger">*</span></label>
												<div class="cal-icon">
													<input id="birth" class="form-control datetimepicker" type="date" name='birth'
                                                     value="{{ $result->birth }}">
												</div>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="zone" class="form-control" placeholder="Write zone or village any address" type="text" name='zone'
                                                 value="{{ $result->zone }}">
											</div>
										</div>
										<div class="col-md-6">
        ...
        <div id="change-password" class="" role="" style="display: none;">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document" >
                <div class="modal-content" >
                    ...
                    <form method="POST"  id="offerForm" enctype="multipart/form-data" action="{{ route('admin.chang-patient-pass') }}" >
                        @csrf
