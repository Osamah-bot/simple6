    ...
    <section id="appointment" class="appointment section-bg">
        <div class="container">
            ...
            <div class="profile-img">
                <a href="#" class="avatar"><img alt={{ $result->fname }} src={{ asset('storage/patient_images/'.$result->img_url ) }}></a>

            </div>
            <form action="{{ route('accountant.storeappoi') }}" method="POST" role="form" class="php-email-form">
                @csrf
                <h4>Patient Info</h4>
                <div class="row">
